  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-sidebar ease-soft",
      ...
      <div
        ...
        suppressHydrationWarning={true}
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-sidebar ease-soft md:flex",
          side === "left"
